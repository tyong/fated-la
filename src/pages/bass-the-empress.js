...
export default () => (
  <ResultPage
    ...
    inPlainTerms={`Karen Bass argues Inside Safe, her signature homelessness program, is working—even with its flaws—and cites her housing permitting reforms as proof that the city can follow through.\n\nOn the Palisades fire, she frames the failure as decades in the making, not one person's fault, and cautions against using other people's grief for political points.\n\nBass wants more police officers on the street.\n\nShe defends sanctuary city protections.\n\nShe acknowledges the budget deficit but prefers careful fixes rather than torching the whole budget.\n\nShe believes in "staying the course," but that only works if the course is actually going somewhere. Whether it is remains to be seen.`}
