...
export default () => (
  <ResultPage
    ...
    inPlainTerms={`Nithya Raman says Bass’ signature homelessness program Inside Safe costs too much for what it delivers—about $225 a night—and that nearly half of participants end up back on the street. She wants the city to break with the Los Angeles Homeless Services Authority, bring the money in-house, and publish dashboards anyone can audit.\n\nOn housing, she backs rent caps and more building.\n\nRaman wants the mansion tax reformed, not repealed: exempting new construction and keeping the tax on luxury property resales. That stance alienates people on both sides, but she reads that as a sign that she's onto something.\n\nShe pledged carbon neutrality by 2030 and talks about it like a deadline, not a moodboard.\n\nOne caveat: she entered the race hours before the filing deadline. Her organization is newer than her rivals'. Big ideas still need infrastructure—and hers is still coming into focus.`}
    shadowTitle={"Your Shadow Card:\nThe Empress"}
    shadowName="KAREN BASS"
    shadowArcana="THE EMPRESS"
    shadowImg="/cards/karen-bass-the-empress.png"
    shadowImgLeft={22}
    shadowText={`Nithya Raman endorsed Karen Bass. She has voted with Bass on most things. Raman's criticism of Inside Safe is about cost efficiency — not that it's the wrong idea.\n\nIn a different timeline, she's Bass's deputy mayor. Instead, she's running against her.\n\nWhat separates them is Raman's conviction that the job needs different hands. Whether you find that compelling or suspicious depends on how you believe her story.\n\nThis card asks you: Is Raman running to be mayor, or for a better version of the same administration?`}
